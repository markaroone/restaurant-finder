...
## Architecture
See [docs/README.md](./docs/README.md) for the technical blueprint.

## Documentation
- [Product Spec](./docs/product.md) — Features and requirements
- [Technical Blueprint](./docs/README.md) — Architecture and API spec
- [Development Tracker](./docs/tracker.md) — Progress tracking
- [Architecture Decisions](./docs/decisions.md) — ADRs with rationale
