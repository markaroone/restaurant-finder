...
async function runTasks() {
  ...
  const tasks = isFixMode
    ? [
        { name: 'Formatting code with Prettier...', cmd: 'bun run format' },
        { name: 'Auto-fixing ESLint issues...', cmd: 'bun run lint:fix' },
      ]
    : [
        { name: 'Checking formatting...', cmd: 'bun run format:check' },
        { name: 'Running ESLint...', cmd: 'bun run lint' },
        { name: 'Typechecking with TypeScript...', cmd: 'bun run typecheck' },
      ];
